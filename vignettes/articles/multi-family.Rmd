...
| Families ending in `_mix()`, `ordbeta()`, or fixed `student(df = ...)` in multi-family mode | Not supported | Use a supported family combination, or fit those models separately. |

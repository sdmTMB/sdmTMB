...
These models could alternatively be referred to as "distributed lag" models.

We start with a simple spatial diffusion example and then fit a an example that combines `space()` and `time()` terms.

Users are encouraged to read and cite @lindmark2025 and @thorson2026 when using these models.

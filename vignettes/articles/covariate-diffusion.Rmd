...
The response is a function of the smooth field, but we only provide the fine-scale predictor (`x1`) to the model. To fit a covariate diffusion model with spatial diffusion, we add the one sided formula `~ space(x1)` to the `covariate_diffusion` argument.

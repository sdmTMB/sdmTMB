...
Next, we'll fit a spatiotemporal model for dogfish density using a delta-gamma family. A delta generalized-gamma family (Dunic et al. 2025) or a Tweedie family could have been used too. We'll include depth as a predictor using a quadratic effect:

...
The output also reports `MSDK[x1]` and `RMSDK[x1]`, the implied mean-squared diffusion-kernel scale (`4 / kappaS_nl[x1]^2`) and its square root (`2 / kappaS_nl[x1]`). We describe these in the next section.

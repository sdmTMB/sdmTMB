...
```{r}
plot_diffusion_kernel(fit, component = "diffusion")
plot_diffused_covariate(fit, component = "diffusion")
```
...
```{r plot-diffusion}
plot_diffusion_kernel(fit_st, component = "diffusion")
plot_diffusion_kernel(fit_st, component = "time_lag", common_scale = TRUE)
...
```{r}
plot_diffused_covariate(fit_st, component = "diffusion")
plot_diffused_covariate(fit_st, component = "time_lag", n_steps = 2)
plot_diffused_covariate(fit_st, component = "combined", n_steps = 2)
```

...
We can extract the DHARMa residuals if we want to plot them ourselves. E.g., let's extract the DHARMa residuals from a model and make a QQ plot for each year:

...
We can extract the DHARMa residuals if we want to plot them ourselves. E.g., lets extract the DHARMa residuals from a model and make a QQ plot for each year:
...
# a little function to calculate the quantile-quantile values:
make_qq <- function(x) {
...
# apply out function to each year:

...
For a Poisson-link delta model [@thorson2018poisson], the log expected catch is the sum of the two link predictors, $h_{g,t} = \eta^{*}_{1,g,t} + \eta^{*}_{2,g,t}$, again with the offset in the second component only.

...
- mcmc_samples:
  ...
  A vector or matrix of MCMC samples of the linear predictor in link
...
are taken as their EB estimates. These used to be the default residual
type in sdmTMB (and were called `mle-laplace`). They are available for

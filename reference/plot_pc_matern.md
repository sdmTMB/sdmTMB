...
A plot from
[`graphics::image()`](https://rdrr.io/r/graphics/image.html). Invisibly
returns the underlying matrix data. The rows are the sigmas. The columns
are the ranges. Column and row names are provided.

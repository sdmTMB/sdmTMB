...
Plot (and optionally return) DHARMa residual diagnostics. This is a
wrapper around
...
models. **Note:** We recommend setting `type = "mle-mvn"` in
[`simulate.sdmTMB()`](https://sdmTMB.github.io/sdmTMB/reference/simulate.sdmTMB.md)
so the resulting residuals have the expected distribution. This is *not*
the default.
...
- simulated_response:
  ...
  Output from
  [`simulate.sdmTMB()`](https://sdmTMB.github.io/sdmTMB/reference/simulate.sdmTMB.md).
  We recommend setting `type = "mle-mvn"` in the call to
  [`simulate.sdmTMB()`](https://sdmTMB.github.io/sdmTMB/reference/simulate.sdmTMB.md)
  so the residuals have the expected distribution.
...
Advantages of these residuals relative to the

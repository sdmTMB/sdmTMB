...
- xy_cols:
  ...
  should generally be in a projected CRS with distance-based units. For
  a helper function to convert to UTMs, see
...
- fmesher_func:
  ...
  along with versions without the `_inla` suffix.
...
own ggplot2 version, pass `your_mesh$mesh` to
[`inlabru::gg()`](https://inlabru-org.github.io/inlabru/reference/gg.html).

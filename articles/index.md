...
- [Models for bounded proportional data in sdmTMB: ZOIB and ordered
  beta](https://sdmTMB.github.io/sdmTMB/articles/zoib.md):
- [Fitting multiple data types at once with
  sdmTMB](https://sdmTMB.github.io/sdmTMB/articles/multi-family.md):
...
- [Areal models in sdmTMB: SAR, CAR, and SPDE
  comparison](https://sdmTMB.github.io/sdmTMB/articles/areal-sar-car-spde.md):
- [Grid areal models in sdmTMB: CAR, SAR, and SPDE
  comparison](https://sdmTMB.github.io/sdmTMB/articles/areal-grid-sar-car-spde.md):
...
- [Estimating non-local covariate effects with sdmTMB: spatial diffusion
  and time
  lags](https://sdmTMB.github.io/sdmTMB/articles/nonlocal-covariates.md):
...
- [Spatially varying coefficients with factor
  predictors](https://sdmTMB.github.io/sdmTMB/articles/svc-factor-models.md):

...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.000963 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 9.63 seconds.
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.00212 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 21.2 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 29.979 seconds (Warm-up)
#> Chain 1:                27.534 seconds (Sampling)
#> Chain 1:                57.513 seconds (Total)
#> Chain 1:

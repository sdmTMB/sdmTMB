...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.000969 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 9.69 seconds.
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 6.784 seconds (Warm-up)
#> Chain 1:                4.708 seconds (Sampling)
#> Chain 1:                11.492 seconds (Total)
#> Chain 1:
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002182 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 21.82 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 30.509 seconds (Warm-up)
#> Chain 1:                27.923 seconds (Sampling)
#> Chain 1:                58.432 seconds (Total)
#> Chain 1:

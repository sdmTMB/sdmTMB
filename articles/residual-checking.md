...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 5.488 seconds (Warm-up)
#> Chain 1:                4.051 seconds (Sampling)
#> Chain 1:                9.539 seconds (Total)
#> Chain 1:
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002065 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 20.65 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 22.709 seconds (Warm-up)
#> Chain 1:                19.059 seconds (Sampling)
#> Chain 1:                41.768 seconds (Total)
#> Chain 1:

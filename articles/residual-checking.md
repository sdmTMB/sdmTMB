...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.000975 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 9.75 seconds.
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 6.745 seconds (Warm-up)
#> Chain 1:                4.668 seconds (Sampling)
#> Chain 1:                11.413 seconds (Total)
#> Chain 1:
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.00216 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 21.6 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 29.89 seconds (Warm-up)
#> Chain 1:                27.481 seconds (Sampling)
#> Chain 1:                57.371 seconds (Total)
#> Chain 1:

...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 6.799 seconds (Warm-up)
#> Chain 1:                4.691 seconds (Sampling)
#> Chain 1:                11.49 seconds (Total)
#> Chain 1:
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002123 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 21.23 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 30.24 seconds (Warm-up)
#> Chain 1:                27.806 seconds (Sampling)
#> Chain 1:                58.046 seconds (Total)
#> Chain 1:

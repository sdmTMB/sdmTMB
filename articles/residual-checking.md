...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.001084 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 10.84 seconds.
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 6.788 seconds (Warm-up)
#> Chain 1:                4.886 seconds (Sampling)
#> Chain 1:                11.674 seconds (Total)
#> Chain 1:
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002148 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 21.48 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 33.157 seconds (Warm-up)
#> Chain 1:                32.675 seconds (Sampling)
#> Chain 1:                65.832 seconds (Total)
#> Chain 1:

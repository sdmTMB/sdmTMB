...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 6.797 seconds (Warm-up)
#> Chain 1:                4.67 seconds (Sampling)
#> Chain 1:                11.467 seconds (Total)
#> Chain 1:
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002202 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 22.02 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 31.031 seconds (Warm-up)
#> Chain 1:                28.307 seconds (Sampling)
#> Chain 1:                59.338 seconds (Total)
#> Chain 1:

...
To keep those uncertainty sources while propagating dynamic future
effects at their conditional means, use `sample_future_re = FALSE`:
...
![](forecasting_files/figure-html/unnamed-chunk-8-1.png)

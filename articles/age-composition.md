...
#> ~0 + ageage_1 + ageage_2 + ageage_3 + ageage_4 + ageage_5 + ageage_6 + 
...
ind_list <- lapply(ages, function(age) {
  ...
  ind <- get_index(fit_sdmTMB, newdata = nd_age,
    area = cell_area, bias_correct = TRUE)
...
#> 1 0.02068169 0.2419754 428.8274    559.3833 2018 age_1
#> 2 0.02211659 0.2575352 390.9094    559.3833 2018 age_2
#> 3 0.01298229 0.1119492 589.8696    559.3833 2018 age_3
#> 4 0.01290741 0.1156016 613.6683    559.3833 2018 age_4
#> 5 0.01524936 0.1462638 536.9793    559.3833 2018 age_5
#> 6 0.01378957 0.1266747 581.7874    559.3833 2018 age_6
```

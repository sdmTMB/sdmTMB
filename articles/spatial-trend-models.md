...
uncertainty standard error is [most accurately
computed](https://github.com/sdmTMB/sdmTMB/discussions/529#discussioncomment-16855394)
(i.e., most correct) at the vertices (or knots) of the mesh. In between
the vertices, bilinear interpolation results in less apparent
uncertainty, but this is a product of the bilinear interpolation.
